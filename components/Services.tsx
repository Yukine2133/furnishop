...
const Services = () => {
  return (
    <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-[6.25rem] mt-72 md:mt-60 lg:mt-[7.625rem] overflow-hidden px-4 ">
      <section>
        <Image
          src="/services.svg"
          alt="Services Image"
      ...
      <section>
        ...
        <span className="w-[21.25rem]  md:w-[25rem] lg:w-[36.69rem] text-lg block text-blue-gray">
        ...
        <div className="space-y-8    mt-[2.1875rem]">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm  w-[18.25rem]  lg:w-[29.19rem] block text-blue-gray">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm w-[18.25rem] lg:w-[29.19rem] inline-block text-blue-gray">
                Sometimes features require a short description. This can be
                detailed description
              </p>
            </div>
